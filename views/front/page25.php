...
<div class="panel-body">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="">Права</a></li>
...
<br>
    ...
    <div class="checkbox lt">
        <label><input type="checkbox">Доступ в систему</label>
    </div>
    <div class="checkbox lt">
        <label><input type="checkbox">Админимтратор</label>
    </div>

    <div class="checkbox lt">
        <label><input type="checkbox">Приемка</label>
    </div>
    <div class="checkbox lt">
        <label><input type="checkbox">Инженер</label>
    </div>
    <div class="checkbox lt">
    ...
    <div class="checkbox lt">
        <label><input type="checkbox">Склад</label>
    </div>
    <div class="checkbox lt">
        <label><input type="checkbox">Бухгалтер</label>
    </div>
    <div class="checkbox lt">
        <label><input type="checkbox">ХХХ</label>
    </div>
